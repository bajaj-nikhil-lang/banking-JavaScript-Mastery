      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://bajaj-group.sentry.io/issues/?project=4511041785561088"
          >
            Issues Page
          </a>
        ...
        <button
          ...
          onClick={async () => {
            ...
            // chatgpt code for 1 line
            // throw new Error(
            //   "This error is raised on the frontend of the example page.",
            // );

            try {
              throw new Error("This error is raised on the frontend of the example page.");
            } catch (error) {
